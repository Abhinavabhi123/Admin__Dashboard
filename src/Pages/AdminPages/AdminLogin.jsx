...
export default function AdminLogin() {
  return (
    <div className="w-screen h-screen bg-white px-10 md:px-0 flex justify-center items-center ">
      <div className="w-[80rem] h-[90%] md:h-[80%] bg-transparent flex flex-col shadow-lg border-t shadow-gray-400 md:flex-row rounded-lg overflow-hidden">
        <div className="w-full h-1/2 md:w-1/2 md:h-full bg-transparent flex justify-center items-center">
          <AdminLoginForm />
        </div>
        <div className="w-full h-1/2 md:w-1/2 md:h-full relative flex items-center">
          ...
          <img src={LoginImage} alt="image" className="relative w-96" />
        </div>
      </div>
    </div>
  );
