...
export default function CreateProduct() {
  ...
  const validationSchema = Yup.object().shape({
    name: Yup.string()
      ...
      .matches(
        /^[a-zA-Z\s.]*$/,
        "Only alphabets, spaces, and dot characters are allowed"
      )
      .required("Name is required"),
    basePrice: Yup.number()
      .moreThan(-1, "Price must be a non-negative number")
      .required("Price is required"),
    stock: Yup.number()
      .moreThan(-1, "Stock must be a non-negative number")
    ...
    discount: Yup.number("Discount should be a number")
      .moreThan(-1, "Price must be a non-negative number")
      .optional(),
    ...
    warranty: Yup.string()
      .matches(
        /^[a-zA-Z0-9 _.\s]*$/,
        "Only letters, numbers, spaces, underscores, and periods are allowed"
      )
